...
+ Tackle any [open issues](https://github.com/ohmybrew/Basic-Shopify-Resource/issues)
+ Help review [pull requests](https://github.com/ohmybrew/Basic-Shopify-Resource/pulls)
...
1. Ensure the bug was not already reported by [searching all issues](https://github.com/ohmybrew/Basic-Shopify-Resource/issues?q=).
...
`git remote add upstream git@github.com:ohmybrew/Basic-Shopify-Resource.git`
